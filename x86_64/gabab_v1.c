...
#define nrn_init _nrn_init__GABAb_S_v1
#define _nrn_initial _nrn_initial__GABAb_S_v1
#define nrn_cur _nrn_cur__GABAb_S_v1
#define _nrn_current _nrn_current__GABAb_S_v1
#define nrn_jacob _nrn_jacob__GABAb_S_v1
#define nrn_state _nrn_state__GABAb_S_v1
#define _net_receive _net_receive__GABAb_S_v1 
#define bindkin bindkin__GABAb_S_v1 
...
#define Cdur Cdur_GABAb_S_v1
 double Cdur = 0.3;
#define Cmax Cmax_GABAb_S_v1
 double Cmax = 0.5;
#define Erev Erev_GABAb_S_v1
 double Erev = -95;
#define KD KD_GABAb_S_v1
 double KD = 100;
#define K4 K4_GABAb_S_v1
 double K4 = 0.033;
#define K3 K3_GABAb_S_v1
 double K3 = 0.098;
#define K2 K2_GABAb_S_v1
 double K2 = 0.0013;
#define K1 K1_GABAb_S_v1
 double K1 = 0.52;
#define n n_GABAb_S_v1
 double n = 4;
 ...
 "Cmax_GABAb_S_v1", &Cmax_GABAb_S_v1,
 "Cdur_GABAb_S_v1", &Cdur_GABAb_S_v1,
 "K1_GABAb_S_v1", &K1_GABAb_S_v1,
 "K2_GABAb_S_v1", &K2_GABAb_S_v1,
 "K3_GABAb_S_v1", &K3_GABAb_S_v1,
 "K4_GABAb_S_v1", &K4_GABAb_S_v1,
 "KD_GABAb_S_v1", &KD_GABAb_S_v1,
 "n_GABAb_S_v1", &n_GABAb_S_v1,
 "Erev_GABAb_S_v1", &Erev_GABAb_S_v1,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 3;
 	...
 	ivoc_help("help ?1 GABAb_S_v1 /home/jchen/Desktop/neurosim/epilepsy/x86_64/gabab_v1.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jchen/Desktop/neurosim/epilepsy/mods/gabab_v1.mod";
static const char* nmodl_file_text = 
