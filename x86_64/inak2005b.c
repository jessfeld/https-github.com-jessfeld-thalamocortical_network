...
#define nrn_init _nrn_init__inak2005b
#define _nrn_initial _nrn_initial__inak2005b
#define nrn_cur _nrn_cur__inak2005b
#define _nrn_current _nrn_current__inak2005b
#define nrn_jacob _nrn_jacob__inak2005b
#define nrn_state _nrn_state__inak2005b
#define _net_receive _net_receive__inak2005b 
#define _f_trates _f_trates__inak2005b 
#define rates rates__inak2005b 
#define states states__inak2005b 
#define trates trates__inak2005b 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_inak2005b", _hoc_setdata,
 "rates_inak2005b", _hoc_rates,
 "states_inak2005b", _hoc_states,
 "trates_inak2005b", _hoc_trates,
 "vtrap_inak2005b", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_inak2005b
...
#define type type_inak2005b
 double type = 0;
#define usetable usetable_inak2005b
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_inak2005b", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_inak2005b", "mho/cm2",
 "gkfbar_inak2005b", "mho/cm2",
 "mvhalf_inak2005b", "mV",
 "hvhalf_inak2005b", "mV",
 "svhalf_inak2005b", "mV",
 "hshift_inak2005b", "mV",
 "sshift_inak2005b", "mV",
 "mtaubase_inak2005b", "ms",
 "htaubase_inak2005b", "ms",
 "htauvhalf_inak2005b", "mV",
 "staubase_inak2005b", "ms",
 "stauvhalf_inak2005b", "mV",
 "gnat_inak2005b", "mho/cm2",
 "gkf_inak2005b", "mho/cm2",
 "inat_inak2005b", "mA/cm2",
 "mtau_inak2005b", "ms",
 "htau_inak2005b", "ms",
 "stau_inak2005b", "ms",
 "nftau_inak2005b", "ms",
 ...
 "type_inak2005b", &type_inak2005b,
 "usetable_inak2005b", &usetable_inak2005b,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "kf_ion");
 	...
 	ivoc_help("help ?1 inak2005b /home/jchen/Desktop/neurosim/epilepsy/x86_64/inak2005b.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("inak2005b", "cannot be used with CVODE"); return 0;}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jchen/Desktop/neurosim/epilepsy/mods/inak2005b.mod";
static const char* nmodl_file_text = 
  ":  ichanWT2005.mod \n"
