...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 it2 /home/jchen/Desktop/neurosim/epilepsy/x86_64/IT2.mod\n");
...
static int  evaluate_fct ( _threadargsprotocomma_ double _lv ) {
   ...
   tau_h = ( taubase + 1.0 / ( exp ( ( _lv + shift + 46.0 ) / 4.0 ) + exp ( - ( _lv + shift + 405.0 ) / 50.0 ) ) ) / phi_h ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jchen/Desktop/neurosim/epilepsy/mods/IT2.mod";
static const char* nmodl_file_text = 
