...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 gap /home/jchen/Desktop/neurosim/epilepsy/x86_64/gapJ.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jchen/Desktop/neurosim/epilepsy/mods/gapJ.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	SUFFIX gj\n"
  "	POINT_PROCESS gap\n"
