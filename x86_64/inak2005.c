...
#define nrn_init _nrn_init__inak2005
#define _nrn_initial _nrn_initial__inak2005
#define nrn_cur _nrn_cur__inak2005
#define _nrn_current _nrn_current__inak2005
#define nrn_jacob _nrn_jacob__inak2005
#define nrn_state _nrn_state__inak2005
#define _net_receive _net_receive__inak2005 
#define _f_trates _f_trates__inak2005 
#define rates rates__inak2005 
#define states states__inak2005 
#define trates trates__inak2005 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_inak2005", _hoc_setdata,
 "rates_inak2005", _hoc_rates,
 "states_inak2005", _hoc_states,
 "trates_inak2005", _hoc_trates,
 "vtrap_inak2005", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_inak2005
...
#define type type_inak2005
 double type = 0;
#define usetable usetable_inak2005
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_inak2005", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_inak2005", "mho/cm2",
 "gkfbar_inak2005", "mho/cm2",
 "mvhalf_inak2005", "mV",
 "hvhalf_inak2005", "mV",
 "svhalf_inak2005", "mV",
 "hshift_inak2005", "mV",
 "sshift_inak2005", "mV",
 "mtaubase_inak2005", "ms",
 "htaubase_inak2005", "ms",
 "htauvhalf_inak2005", "mV",
 "staubase_inak2005", "ms",
 "stauvhalf_inak2005", "mV",
 "gnat_inak2005", "mho/cm2",
 "gkf_inak2005", "mho/cm2",
 "inat_inak2005", "mA/cm2",
 "mtau_inak2005", "ms",
 "htau_inak2005", "ms",
 "stau_inak2005", "ms",
 "nftau_inak2005", "ms",
 ...
 "type_inak2005", &type_inak2005,
 "usetable_inak2005", &usetable_inak2005,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "kf_ion");
 	...
 	ivoc_help("help ?1 inak2005 /home/jchen/Desktop/neurosim/epilepsy/x86_64/inak2005.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("inak2005", "cannot be used with CVODE"); return 0;}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jchen/Desktop/neurosim/epilepsy/mods/inak2005.mod";
static const char* nmodl_file_text = 
  ":\n"
  ":  ichanWT2005.mod \n"
  ":\n"
